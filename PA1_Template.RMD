...
* The 5-minute interval which had the maximum number of steps was the `r time`th interval.
...
```
* The new mean of the imputed data is `r A_Mean` steps compared to the old mean of `r stepsByDayMean` steps. 
* The new median of the imputed data is `r A_Median` steps compared to the old median of `r stepsByDayMedian` steps.
